...
<p style="text-align: center; margin: 30px 0;">
  <a href="https://wts.sh/confirm-verification?token={TOKEN}" target="_blank" style="display: inline-block; padding: 14px 28px; background-color: #070514; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold;">Verify Email</a>
</p>
...
<p style="text-align: center; margin: 30px 0;">
  <a href="https://wts.sh/confirm-password-reset?token={TOKEN}" target="_blank" style="display: inline-block; padding: 14px 28px; background-color: #070514; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold;">Reset Password</a>
</p>
...
<p style="text-align: center; margin: 30px 0;">
  <a href="https://wts.sh/confirm-password-reset?token={TOKEN}" target="_blank" style="display: inline-block; padding: 14px 28px; background-color: #070514; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold;">Confirm New Email</a>
</p>
  ...
  (app) => {
    ...
    for (const collection of authCollections) {
      collection.verificationTemplate = {
        ...
        body: `<p>Hello,</p>\n<p>Thank you for joining us at {APP_NAME}.</p>\n<p>Click on the button below to verify your email address.</p>\n<p>\n  <a class="btn" href="https://wts.sh/confirm-verification?token={TOKEN}" target="_blank" rel="noopener">Verify</a>\n</p>\n<p>\n  Thanks,<br/>\n  {APP_NAME} team\n</p>`,
      };

      collection.resetPasswordTemplate = {
        subject: "Reset your {APP_NAME} password",
        body: `<p>Hello,</p>\n<p>Click on the button below to reset your password.</p>\n<p>\n  <a class="btn" href="https://wts.sh/confirm-password-reset?token={TOKEN}" target="_blank" rel="noopener">Reset password</a>\n</p>\n<p><i>If you didn't ask to reset your password, you can ignore this email.</i></p>\n<p>\n  Thanks,<br/>\n  {APP_NAME} team\n</p>`,
      };

      collection.confirmEmailChangeTemplate = {
        subject: "Confirm your {APP_NAME} new email address",
        body: `<p>Hello,</p>\n<p>Click on the button below to confirm your new email address.</p>\n<p>\n  <a class="btn" href="https://wts.sh/confirm-password-reset?token={TOKEN}" target="_blank" rel="noopener">Confirm new email</a>\n</p>\n<p><i>If you didn't ask to change your email address, you can ignore this email.</i></p>\n<p>\n  Thanks,<br/>\n  {APP_NAME} team\n</p>`,
      };
