...
export default function AdminCommunityPartnerMissions(props: AdminCommunityPartnerMissionsProps) {
  ...
  return <div class="space-y-8">
    ...
    <form class={adminFormPanelClass} onSubmit={save}>
      <AdminFormSection title="Community Partner programme" description="Separate from the partner's public type and tier. Permanent keys use community.{partnerKey}.{activityKey}.">
      ...
      <div class="mt-5 flex flex-wrap items-center justify-between gap-3"><p class="text-xs font-mono text-base-content/60">One accepted claim per User and Activity across every code and reissue.</p><div class="flex gap-2"><button type="button" class="btn btn-ghost font-mono" onClick={reset}>Clear</button><button type="submit" class="btn btn-primary font-mono" disabled={busy()}>Save drafts</button></div></div>
    </form>
