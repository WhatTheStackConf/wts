  ...
  return (
    <div class="space-y-8">
      ...
      <form class={adminFormPanelClass} onSubmit={submitSearch}>
        <AdminFormSection title="Find a support case" description="Enter an exact user ID, email, name, mission/activity/achievement key, code label/prefix, redemption ID, support reference, or Hi.Events source ID.">
      ...
      <form class={adminFormPanelClass} onSubmit={submitPartnerHandoff}>
        <AdminFormSection title="One-time partner contact handoff" description="Use a consent ID from an authenticated support case only. The admin, partner, activity, time, and approved fields are logged; copied contact values are not stored.">
