...
| | |
|---|---|
| **Regular ticket** | <RegularTicketPrice /> |
| **Student ticket** | <StudentTicketPrice /> |
| **Duration** | 1 day (<ConferenceDate />) |
...
> **Subject: Conference request - WhatTheStack 2026 (<ConferenceDate />, <ConferenceLocation />)**
>
> Hi [Manager's name],
>
> I'd like to attend WhatTheStack 2026, a software engineering conference in <ConferenceLocation /> on <ConferenceDate />. It covers the full stack - web, AI/ML, infrastructure, DevOps - with 30+ talks across 4 tracks, plus hands-on workshops.
>
...
>
> The ticket is <RegularTicketPrice />, which includes all talks, food, and drinks for the full day. There are also optional paid workshops available as add-ons. I'd be happy to share a summary of key takeaways with the team afterward.
>
> Here's the website: [wts.sh](https://wts.sh)
>
...
Sending a group? We offer volume discounts and invoicing for teams. Reach out at <GeneralContactEmail /> and we'll sort it out.

## Still need more convincing?

We can't help you there - but [last year's talks on YouTube](https://www.youtube.com/@WhatTheStackConference) might. Show your boss a few of those and let the content speak for itself.
